...
function MarkerPopup({
  ...
  return createPortal(
    <div
      className={cn(
        "bg-space-900/95 text-slate-100 relative max-w-64 rounded-md border border-hud-cyan/40 p-3 shadow-glow-cyan backdrop-blur-md",
...
function MarkerTooltip({
  ...
  return createPortal(
    <div
      className={cn(
        "bg-space-950/90 text-hud-cyan border border-blue-900/60 pointer-events-none rounded-md px-2 py-1 text-xs text-balance shadow-md font-mono",
        "animate-in fade-in-0 zoom-in-95 duration-200 ease-out",
        className
      )}
    >
  ...
  return (
    <div
      className={cn(
        ...
        "text-hud-cyan text-[10px] font-mono font-medium drop-shadow-[0_1px_2px_rgba(0,0,0,0.8)]",
...
function ControlGroup({ children }: { children: React.ReactNode }) {
  return (
    <div className="border border-blue-900/40 bg-space-900/90 text-slate-200 [&>button:not(:last-child)]:border-blue-900/40 flex flex-col overflow-hidden rounded-md shadow-sm backdrop-blur-sm [&>button:not(:last-child)]:border-b">
      {children}
    </div>
  );
}
  ...
  return (
    <button
      ...
      className={cn(
        ...
        "hover:bg-blue-800/40 hover:text-hud-cyan",
        "focus-visible:ring-hud-cyan focus-visible:ring-1 focus-visible:outline-none",
